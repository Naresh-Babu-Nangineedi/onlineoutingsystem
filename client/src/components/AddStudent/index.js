...
class AddStudent extends Component {
    ...
    onSubmitHandler= async(e)=>{
        ...
        const url = "/api/hostelIncharge/addStudent"
        const options = {
            method:"POST",
        ...
        return (
            <div>
                ...
                <div className="container p-5">
                    <div className="row">
                        <h1 className="col-12 text-center mt-2 mb-2">Add Student</h1>
                           ...
                           {error&&(<p className="text-danger text-center mt-3 mb-3">*{errorMessage}</p>)}
                            ...
                            <button className="btn btn-success btn-block" onClick={this.onSubmitHandler}>Add Student</button>
