...
const {addIncharge,addStudent,loginIncharge,allGenderOutings,approveInchargeOuting,rejectInchargeOuting,updateUser,deleteUser,changeInchargePassword}=require("../controllers/hostelInchargeControllers")
